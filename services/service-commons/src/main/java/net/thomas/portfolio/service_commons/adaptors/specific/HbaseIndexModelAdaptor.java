 ...
 *
 * Implementations should pre-load the schema from the service on creation to allow for quick
 * lookups.
 *
 */
public interface HbaseIndexModelAdaptor {
	 ...
	 * @return The selector as it would be represented in the model
	 */
	Selector getFromSimpleRep(String type, String simpleRep);
