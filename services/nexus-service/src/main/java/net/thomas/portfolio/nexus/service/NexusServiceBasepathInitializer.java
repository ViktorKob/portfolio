...
@Component
public class NexusServiceBasepathInitializer extends ContextPathPropertySource implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {

	public NexusServiceBasepathInitializer() {
		super(NEXUS_SERVICE_PATH);
	}
