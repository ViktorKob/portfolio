...
/**
 * A class modelling foreign key relationships between tables of the <code>usage_data</code> 
 * schema
 */
@Generated(
    value = {
...
public class Keys {
    ...
    private static class Identities0 extends AbstractKeys {
        public static Identity<AccessTypeRecord, UInteger> IDENTITY_ACCESS_TYPE = createIdentity(AccessType.ACCESS_TYPE, AccessType.ACCESS_TYPE.ID);
        public static Identity<UserRecord, UInteger> IDENTITY_USER = createIdentity(User.USER, User.USER.ID);
        public static Identity<UserAccessedDocumentRecord, UInteger> IDENTITY_USER_ACCESSED_DOCUMENT = createIdentity(UserAccessedDocument.USER_ACCESSED_DOCUMENT, UserAccessedDocument.USER_ACCESSED_DOCUMENT.ROW);
    }

    private static class UniqueKeys0 extends AbstractKeys {
        public static final UniqueKey<AccessTypeRecord> KEY_ACCESS_TYPE_PRIMARY = createUniqueKey(AccessType.ACCESS_TYPE, "KEY_access_type_PRIMARY", AccessType.ACCESS_TYPE.ID);
        public static final UniqueKey<AccessTypeRecord> KEY_ACCESS_TYPE_NAME_UNIQUE = createUniqueKey(AccessType.ACCESS_TYPE, "KEY_access_type_name_UNIQUE", AccessType.ACCESS_TYPE.NAME);
        public static final UniqueKey<UserRecord> KEY_USER_PRIMARY = createUniqueKey(User.USER, "KEY_user_PRIMARY", User.USER.ID);
        public static final UniqueKey<UserRecord> KEY_USER_NAME_UNIQUE = createUniqueKey(User.USER, "KEY_user_name_UNIQUE", User.USER.NAME);
        public static final UniqueKey<UserAccessedDocumentRecord> KEY_USER_ACCESSED_DOCUMENT_PRIMARY = createUniqueKey(UserAccessedDocument.USER_ACCESSED_DOCUMENT, "KEY_user_accessed_document_PRIMARY", UserAccessedDocument.USER_ACCESSED_DOCUMENT.ROW);
        public static final UniqueKey<UserAccessedDocumentRecord> KEY_USER_ACCESSED_DOCUMENT_ROW_UNIQUE = createUniqueKey(UserAccessedDocument.USER_ACCESSED_DOCUMENT, "KEY_user_accessed_document_row_UNIQUE", UserAccessedDocument.USER_ACCESSED_DOCUMENT.ROW);
    }
}
