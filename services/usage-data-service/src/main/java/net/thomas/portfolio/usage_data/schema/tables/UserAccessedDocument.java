...
public class UserAccessedDocument extends TableImpl<UserAccessedDocumentRecord> {
    ...
    private static final long serialVersionUID = -1977999971;
     ...
     */
    public final TableField<UserAccessedDocumentRecord, UInteger> ROW = createField("row", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>usage_data.user_accessed_document.document_type</code>.
     */
    public final TableField<UserAccessedDocumentRecord, String> DOCUMENT_TYPE = createField("document_type", org.jooq.impl.SQLDataType.VARCHAR.length(45).nullable(false), this, "");

    /**
     * The column <code>usage_data.user_accessed_document.document_uid</code>.
     */
    public final TableField<UserAccessedDocumentRecord, String> DOCUMENT_UID = createField("document_uid", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false), this, "");
     ...
     */
    public final TableField<UserAccessedDocumentRecord, Timestamp> TIME_OF_ACCESS = createField("time_of_access", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * Create a <code>usage_data.user_accessed_document</code> table reference
     */
    public UserAccessedDocument() {
        this("user_accessed_document", null);
    }
    ...
    private UserAccessedDocument(String alias, Table<UserAccessedDocumentRecord> aliased) {
        this(alias, aliased, null);
    }

    private UserAccessedDocument(String alias, Table<UserAccessedDocumentRecord> aliased, Field<?>[] parameters) {
