...
public class UsageDataSqlProxy {
	...
	public UsageDataSqlProxy(Database databaseConfig) {
	...
	private void createAndInitializeDatabase(Connection connection) throws SQLException {
		try (Statement statement = connection.createStatement()) {
			...
			final InputStream schemaStream = getClass().getClassLoader()
				.getResourceAsStream("schema/usage_data_schema.sql");
			try (final BufferedReader reader = new BufferedReader(new InputStreamReader(schemaStream))) {
