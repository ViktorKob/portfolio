...
public class SimpleRepresentationRendererLibrary implements Renderer<String> {
	private final SimpleRepresentationRendererLibrary library;
	private final Map<String, Renderer<String>> renderers;

	public SimpleRepresentationRendererLibrary() {
		library = this;
