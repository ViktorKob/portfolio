...
public class AutoGeneratedEntityMethodsUnitTest {
	...
	public void shouldNotBeEqualToNull() {
		runTestOnAllEntityTypes((entity) -> {
			assertFalse("Comparisson of entity to null had unexpected outcome for " + entity, entity == null);
		});
		assertTrue(TEST_DONE); // Here to fix code analysis issue
	}
	...
	public void shouldNotEqualToCopyOfItselfWithNullField() {
		runTestOnAllEntityTypes((entity) -> {
			for (final Field field : getFieldsExceptUid(entity)) {
				if (!"uid".equals(field.getName())) {
					assertNewInstanceWithFieldAsNullIsNotEqualToOriginalButIsEqualToIdenticalCopy(entity, field);
				}
			}
		});
		assertTrue(TEST_DONE); // Here to fix code analysis issue
	...
	private void assertNewInstanceWithFieldAsNullIsNotEqualToOriginalButIsEqualToIdenticalCopy(Entity entity, Field field)
			throws InstantiationException, IllegalAccessException, InvocationTargetException {
		...
		assertFalse("Comparisson of entity to different object type had unexpected outcome for:\n" + entity + "\n" + newInstance1, entity.equals(newInstance1));
		assertFalse("Comparisson of entity to different object type had unexpected outcome for:\n" + newInstance1 + "\n" + entity, newInstance1.equals(entity));
		assertTrue("Comparisson of entity to different object type had unexpected outcome for:\n" + newInstance1 + "\n" + newInstance2,
