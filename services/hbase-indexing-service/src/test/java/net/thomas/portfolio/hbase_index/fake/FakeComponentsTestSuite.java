...
import net.thomas.portfolio.hbase_index.fake.events.WorldDiskIoIntegrationTest;
...
@Suite.SuiteClasses({ FakeHbaseIndexUnitTest.class, GeneratorTestSuite.class, FakeInvertedIndexStepUnitTest.class,
		FakeSelectorStatisticsStepUnitTest.class, WorldDiskIoIntegrationTest.class })
