...
@RunWith(Suite.class)
@Suite.SuiteClasses({ HbaseIndexingModelTextRendererLibraryUnitTest.class, HbaseIndexingModelSimpleRepresentationRendererLibraryUnitTest.class,
		RenderServiceControllerServiceAdaptorTest.class })
