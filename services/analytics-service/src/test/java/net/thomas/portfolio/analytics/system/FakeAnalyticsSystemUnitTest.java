...
public class FakeAnalyticsSystemUnitTest {
	...
	private FakeAnalyticsSystem analyticsSystem;
	...
	public void shouldBeUnknown() {
		...
		final AnalyticalKnowledge knowledge = analyticsSystem.getPriorKnowledge(id);
