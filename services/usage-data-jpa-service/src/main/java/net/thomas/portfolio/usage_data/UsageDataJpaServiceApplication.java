...
import static net.thomas.portfolio.services.configuration.UsageDataJpaServiceProperties.loadUsageDataJpaConfigurationIntoProperties;
...
public class UsageDataJpaServiceApplication {
	@Configuration
	...
	static class CsrfBugWorkaround extends WebSecurityConfigurerAdapter {
		...
		protected void configure(HttpSecurity http) throws Exception {
			http.csrf().disable().authorizeRequests().anyRequest().authenticated().and().httpBasic().and().headers().frameOptions().sameOrigin();
		}
	}
	...
	public static void main(String[] args) {
		...
		loadUsageDataJpaConfigurationIntoProperties();
		run(UsageDataJpaServiceApplication.class, args);
	}
}