...
public class FieldDeserializer extends JsonDeserializer<Field> {
	...
	public Field deserialize(JsonParser parser, DeserializationContext context) throws IOException, JsonProcessingException {
		...
		final FieldType fieldType = FieldType.valueOf(root.get("fieldType").asText());
		switch (fieldType) {
			case PRIMITIVE:
			...
			default:
				throw new ProgrammingException("Deserializer for field of type " + fieldType + " is not implemented");
		}
	}
}
