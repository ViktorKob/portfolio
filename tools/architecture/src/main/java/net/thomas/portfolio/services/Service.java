...
public enum Service implements ServiceEndpoint {
	ANALYTICS_SERVICE(ANALYTICS_SERVICE_PATH), HBASE_INDEXING_SERVICE(HBASE_INDEXING_SERVICE_PATH), LEGAL_SERVICE(LEGAL_SERVICE_PATH), RENDER_SERVICE(
			RENDER_SERVICE_PATH), USAGE_DATA_SERVICE(USAGE_DATA_SERVICE_PATH);
