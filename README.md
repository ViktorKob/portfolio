...
| **User** | service-user |
| **Password** | password |
| **Endpoints** | <ul><li>/Nexus/schema.json</li><li>/Nexus/graphql</li><li>/Nexus/graphiql</li> |
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/HbaseIndex/swagger-ui.html)|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|<ul><li>[Swagger](https://viktorkob.ml/Legal/swagger-ui.html)</li><li>[Query history (Reactive)](https://viktorkob.ml/Legal/)</li>|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/Render/swagger-ui.html)|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/UsageData/swagger-ui.html)|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/Analytics/swagger-ui.html)|
