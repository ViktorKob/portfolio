...
| [Hystrix](https://viktorkob.ml/Infrastructure/hystrix/monitor?stream=https%3A%2F%2Fservice-user%3Apassword%40viktorkob.ml%2FNexus%2Factuator%2Fhystrix.stream&delay=1000&title=Nexus%20Service%20Monitor) | A Hystrix dashboard for the adaptors that have circuit breakers (only available on the Nexus at the moment). Is less boring if you run some queries while looking at it, and sometimes fails if no-one has run a query for a while. |
...
~~Note, that unless you also set up a local reverse proxy, you will need to specify ports directly when running queries (as opposed to the examples above). For instance, the hbase service should be running at (localhost:8120/HbaseIndexingService/).~~ You should be able both to go through the proxy on port 80 and to go directly to each service.<BR>
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/HbaseIndexingService/swagger-ui.html)|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|<ul><li>[Swagger](https://viktorkob.ml/LegalService/swagger-ui.html)</li><li>[Query history (Reactive)](https://viktorkob.ml/LegalService/)</li>|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/RenderService/swagger-ui.html)|
...
|**User**|service-user|
|**Password**|password|
|**Endpoints**|[Swagger](https://viktorkob.ml/AnalyticsService/swagger-ui.html)|
