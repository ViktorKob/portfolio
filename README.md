...
|[Hystrix](https://viktorkob.tk/NexusService/hystrix/monitor?stream=http%3A%2F%2Flocalhost%3A8100%2Fhystrix.stream)|A Hystrix dashboard for the adaptors that have curcuit breakers (only available on the Nexus at the moment)|
