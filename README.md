...
| [Admin](https://viktorkob.ml/Admin#/applications) | A server running the Spring Boot Admin tool, connected to the other services. **Currently inaccessible pending fix of URL generation** |
